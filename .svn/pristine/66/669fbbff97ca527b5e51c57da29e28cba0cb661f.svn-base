...
<body>
						...
						<div class="layui-tab-item layui-show">
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<s:iterator var="p" value="%{conclusion.replyList[0].deadline.placeFile.ptSet}" status="i">
										${p.pbtName }
									</s:iterator>
								</div>
							</div>
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									${conclusion.conCorrectionMethodConfirm }
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">考核结论</label>
								<div class="layui-input-block">
									${conclusion.conAssessmentConclusion }
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">考核人</label>
								<div class="layui-input-block">
										${conEx.user.userName }, ${conEx.preDate } 
								</div>
							</div>
							<s:if test="#conEx1 == null">
								<div class="layui-form-item">
									<div class="layui-input-block">
										<button type="button" class="layui-btn" onclick="examine1('1',11)">同意</button>
							...
							<s:if test="#conEx1 != null">
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
											${conEx1.user.userName }, ${conEx1.preDate }
										<%-- <s:iterator value="#conEx1" status="i">
											<s:if test="#conEx1.size()-1 == #i.getIndex()">
												${user.userName }, ${preDate }
											</s:if>
										</s:iterator> --%>
									</div>
								</div>
								<div class="layui-form-item">
									<div class="layui-input-block">
										<button type="button" class="layui-btn" onclick="examine2('1',20)">同意</button>
											...
											<div class="layui-form-item">
												...
												<%-- 	${pr16.user.userName }${pr16.preDate }
													...
													<s:iterator value="#repPr">
														...
														${user.section.department.deptId }===${department.deptId }
													</s:iterator>
												</div>
											</div>
											<div class="layui-form-item">
						...
						<div class="layui-tab-item">
							<div class="layui-form">
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<s:iterator var="app" value="%{deadline.placeFile.feedback.appSet}" status="i">
	...
	function examine1(opinion, proId) {
		...
		location.href = "conDeadlineAction_examine1?opinion=" + opinion + "&process.proId=" + proId + "&deadline.deaId=" + deaId;
	}
	// 部门审批意见
	function examine2(opinion, proId) {
		var deaId = "${deadline.deaId }";
		location.href = "conDeadlineAction_examine2?opinion=" + opinion + "&process.proId=" + proId + "&deadline.deaId=" + deaId;
	}
	</script>
</body>
</html>