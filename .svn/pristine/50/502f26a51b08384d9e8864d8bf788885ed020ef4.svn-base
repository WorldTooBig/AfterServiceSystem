...
<div class="layui-header">
	<div class="layui-logo">银隆新能源</div>
    ...
    <div class="layui-side-scroll">
      ...
      <li class="layui-nav-item layui-nav-itemed layui-this">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a href="${pageContext.request.contextPath}/pages/userInfo.jsp">查看用户信息</a></dd>
            <dd><a href="companyAction_findCompanyList">公司部门信息</a></dd>
            <dd><a href="${pageContext.request.contextPath}/pages/perSystem.jsp">用户权限管理</a></dd>
