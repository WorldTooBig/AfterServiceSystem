...
<body>
					...
					<div class="layui-tab-content">
						<div class="layui-tab-item layui-show">
							...
							<s:if test="#repEx1 != null">
								...
								<div class="layui-form-item">
									<div class="layui-input-block">
										<s:if test="#pr16 != null"><button type="button" class="layui-btn" onclick="examine2('1',16)">同意</button></s:if>
										<s:elseif test="#pr17 != null"><button type="button" class="layui-btn" onclick="examine2('1',17)">同意</button></s:elseif>
										<s:elseif test="#pr18 != null"><button type="button" class="layui-btn" onclick="examine2('1',18)">同意</button></s:elseif>
										<s:else></s:else>
	...
	function examine1(opinion, proId) {
		...
		location.href = "replyDeadlineAction_examine1?opinion=" + opinion + "&process.proId=" + proId + "&reply.repId=" + repId;
	}
	// 部门领导审批意见
	function examine2(opinion, proId) {
		var repId = "${reply.repId }";
		location.href = "replyDeadlineAction_examine2?opinion=" + opinion + "&process.proId=" + proId + "&reply.repId=" + repId;
	}
	</script>
</body>
</html>