...
<body>
						...
						<div class="layui-tab-item layui-show">
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<s:iterator var="p" value="%{conclusion.replyList[0].notified.placeFile.ptSet}" status="i">
										${p.pbtName }
									</s:iterator>
								</div>
							</div>
	...
	function examine1(opinion, proId) {
		var notId = "${notified.notId }";
		location.href = "conclusionAction_examine1?opinion=" + opinion + "&process.proId=" + proId + "&notified.notId=" + notId;
	}
	// 部门审批意见
	function examine2(opinion, proId) {
		var notId = "${notified.notId }";
		location.href = "conclusionAction_examine2?opinion=" + opinion + "&process.proId=" + proId + "&notified.notId=" + notId;
	}
	</script>
</body>
</html>