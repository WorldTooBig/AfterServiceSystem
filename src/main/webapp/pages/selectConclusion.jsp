...
<body>
	...
	layui.use(['jquery', 'laydate', 'form', 'table'], function(){
		...
		table.render({
		    elem: '#tab'
			,url: 'notifiedAction_findNotifiedListOnConclusion'
		...
		table.on('tool(tabFilter)', function(obj){
			...
			if(layEvent == "edit") {
				location.href = "conclusionAction_findConclusionToConclusion?notified.notId=" + data.notId;
			} else if(layEvent == 'detail'){
				location.href = "${pageContext.request.contextPath}/pages/conclusion.jsp?notId=" + data.notId;
			}
		});
