							...
							<form class="layui-form" action="" method="post">
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="radio" name="isDea" value="1" title="同意延期至" checked="">
										<input id="date" name="delay.reqDate" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
										<input type="radio" name="isDea" value="0" title="不同意延期">
									</div>
								</div>
